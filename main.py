...
class UI(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('Resources/Images/1.png'))
        self.fulls.setShortcut("F11")
        self.fulls.setStatusTip("Change to full screen mode")
    ...
    def roll(self):
        arr = ["Resources/Images/1.png", "Resources/Images/2.png", "Resources/Images/3.png", "Resources/Images/4.png",
               "Resources/Images/5.png", "Resources/Images/6.png"]
